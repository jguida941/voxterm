...
- `src/src/bin/codex_overlay/main.rs:46-47` - Atomic flag definition
- `src/src/bin/codex_overlay/main.rs:55-61` - Signal handler
- `src/src/bin/codex_overlay/main.rs:329-334` - Polling logic
